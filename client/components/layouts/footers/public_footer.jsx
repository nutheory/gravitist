      ...
      <div className="container mx-auto py-12">
        <div className="flex flex-wrap md:-mx-6">
          <div className="w-full md:w-1/3 p-6">
            ...
            <p className="text-lg">
              <a href="mailto:contact@homefilming" className="" target="_blank">contact@homefilming</a>
            </p>
            <div className="py-2">
            ...
            <Link className="w-32 block" to="/"><img src={`/${require('../../../assets/svg/hf_logo_white.svg')}`} /></Link>
