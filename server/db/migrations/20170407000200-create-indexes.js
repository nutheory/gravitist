...
module.exports = {
  up: function (queryInterface, Sequelize) {
    ...
    queryInterface.addIndex('companies', ['accountId', 'addressId', 'phoneId', 'logoId'])
    queryInterface.addIndex('phones', ['phonableId', 'phonableType'])
  ...
  down: function (queryInterface, Sequelize) {
    ...
    queryInterface.removeIndex('companies', ['accountId', 'addressId', 'phoneId', 'logoId'])
    queryInterface.removeIndex('phones', ['phonableId', 'phonableType'])
