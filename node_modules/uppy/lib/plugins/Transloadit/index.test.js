...
describe('Transloadit', function () {
  ...
  it('Uses different assemblies for different params', function () {
    ...
    return Promise.all([uppy.addFile({ name: 'a.png', data: data }), uppy.addFile({ name: 'b.png', data: data }), uppy.addFile({ name: 'c.png', data: data }), uppy.addFile({ name: 'd.png', data: data })]).then(function () {
      return uppy.upload().then(function () {
  ...
  it('Should merge files with same parameters into one assembly', function () {
    ...
    return Promise.all([uppy.addFile({ name: 'a.png', data: data }), uppy.addFile({ name: 'b.png', data: data }), uppy.addFile({ name: 'c.png', data: data }), uppy.addFile({ name: 'd.png', data: data2 })]).then(function () {
      return uppy.upload().then(function () {
        throw new Error('Upload should have been rejected');
      }, function () {
        expect(i).toBe(2);
